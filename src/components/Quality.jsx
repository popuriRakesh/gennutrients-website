    ...
    <>
      <section id="quality" className="quality" data-aos="fade-up">
        <div className="quality-header">
          ...
          <p>
            Every ingredient supplied by Gen Nutrients is backed by comprehensive
            documentation, rigorous testing, and industry-standard quality
            controls to ensure consistency, safety, and reliability.
          </p>
        </div>
